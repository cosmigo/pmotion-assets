= Cosmigo Pro Motion Assets{nbsp}{nbsp}image:https://travis-ci.com/tajmone/pmotion-assets.svg[Travis CI,title="EditorConfig code styles validation via Travis CI"]
:lang: en
// TOC Settings:
:toclevels: 5
